...
// Mock data is kept for demonstration purposes, but the expand functionality no longer depends on it.
...
const Dashboard = () => {
	...
	const renderCustomCalendar = () => {
		...
		const selectedSchedule = expandedDay
			? getScheduleForDate(expandedDay)
			: null;
					...
					<AnimatePresence>
						{expandedDay && (
							<motion.div
								...
								onClick={() => setExpandedDay(null)} // Click-away to close on the backdrop
							>
								<motion.div
									...
									onClick={(e) => e.stopPropagation()} // Stop propagation so clicks on the panel don't close it
								>
									<button
	...
	return (
		<div className="space-y-6">
			...
			<Card className="shadow-fm cursor-pointer hover:shadow-fm-hover transition-shadow">
				<CardHeader>
